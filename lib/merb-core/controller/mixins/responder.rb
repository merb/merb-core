...
module Merb
  ...
  module ResponderMixin
    ...
    # @param [Module] base The module that ResponderMixin was mixed into
    #
    # @api private
    ...
    module ClassMethods
      ...
      # method as needed.
      #
      # @param [Symbol] *formats A list of mime-types that the controller
      #   should provide.
      #
      # @return [Array<Symbol>] List of formats passed in.
      #
      # @example
      #     provides :html, :xml
      #
      ...
      #
      # @param [Symbol] *formats Registered mime-types.
      #
      # @return [Array<Symbol>] List of formats passed in.
      #
      # @api public
      ...
      # @param [Symbol] *formats Registered mime-types.
      #
      # @return [Array<Symbol>] List of formats that remain after removing
      #   the ones not to provide.
      #
      # @api public
    ...
    # controller.
    #
    # @param [Symbol] *formats Registered mime-type
    #
    # @return [Array<Symbol>]
    ...
    #    Status 406 if no suitable content type was found.
    #
    # @api private
    ...
    #   of the public API.
    #
    # @return [Symbol] The content-type that will be used for this
    #   controller.
    #
    # @api public
    ...
    #
    # @param [Symbol] type The content type.
    #
    # @raise [ArgumentError] `type` is not in the list of registered
    #   mime-types.
    #
    # @return [Symbol] The content-type that was passed in.
    #
    # @api plugin
  ...
  class Responder
    ...
    #
    # @param [#to_s] accept_header The raw accept header.
    #
    # @return [Array<AcceptType>] The accepted types.
    #
    # @private
  ...
  class AcceptType
    ...
    # @param [String] entry The accept type pattern.
    # @param [Fixnum] index The index used for sorting accept types. A
    ...
    #
    # @param [AcceptType] entry The accept type to compare.
    #
    # @return [Fixnum] -1, 0 or 1, depending on whether entry has a lower,
    #   equal or higher priority than the accept type being compared.
    #
    # @api private
    def <=>(entry)
    ...
    # @return [Fixnum] A hash based on the super range.
    #
    # @api private
    ...
    # @return [Symbol] The type as a symbol, e.g. `:html`.
    #
    # @api private
    def to_sym
    ...
    # @return [String] The accept type as a string, i.e. the media range.
    #
    # @api private
    def to_s
      @media_range
