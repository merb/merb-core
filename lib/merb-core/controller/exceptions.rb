...
class Exception
  ...
  #
  # @return [String] The name of the action in the Exceptions controller which will get invoked
  ...
  # @return [Boolean] Whether or not this exception is the same as another.
  #
  # @api public
  def same?(other)
  ...
  #
  # @return [Integer] The status code to send in the response. Defaults to 500.
  #
  # @api public
  # @overridable
  def self.status
...
module Merb
  ...
  # the error in a friendly manner.
  #
  ...
  module ControllerExceptions
    ...
    # Base class for error codes used in {ControllerExceptions}.
    class Base < StandardError

      # @return [Integer] The status-code of the error.
      #
      # @overridable
      # @api plugin
      ...
      class << self
        ...
        #
        # @return [Fixnum] The status code of this exception.
        #
        # @api public
        def status
        ...
        #
        # @param [#to_i] num The status code
        #
        # @return [Integer, nil] The status set on this exception, or nil
        #   if a status was already set.
        #
        # @api private
        def status=(num)
          unless self.status?
        ...
        #
        # @return [Boolean] Whether a status code has been set
        #
        # @api private
        def status?
        ...
        #
        # @param [Merb::ControllerExceptions::Base] subclass The Exception
        #   class that is inheriting from {Merb::ControllerExceptions::Base}
        #
        # @api public
