...
class Hash
  ...
  # Convert to HashWithIndifferentAccess which used to be Mash. This class has 
  # semantics of ActiveSupport's HashWithIndifferentAccess and we only have it
  # so that people can write
  #
  # params[:key] instead of params['key'].
  #
  # @return [ActiveSupport::HashWithIndifferentAccess] This hash as a Mash for string or symbol key access.
  def to_mash
...
class REXMLUtilityNode
  ...
  class_attribute :typecasts
  class_attribute :available_typecasts
