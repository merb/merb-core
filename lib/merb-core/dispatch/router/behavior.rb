  ...
  class Router
    ...
    class Behavior
      ...
      class Proxy
        ...
        #
        # @see Merb::Rack::Helpers#redirect
        #
        # @api public
        ...
        #
        # @see http://ruby-doc.org/core/classes/Kernel.html#M005951
        #
        # @api private
      ...
      #
      # @param [Proxy] proxy
      #   This is the object initialized by {Router.prepare} that tracks the
      ...
      #
      # @return [Behavior] The initialized Behavior object
      #
      # @api private
      ...
      # passed in.
      #
      # Aliases `with` and `register` are provided to allow some nicer syntax.
      #
      # @param [Hash] params The parameters the route maps to.
      # @param &block
      #   All routes defined in the block will be scoped to the params
      #   defined by the #to method.
      #
      # @yieldparam [Behavior] r The to behavior object (optional).
      #
      # @return [Behavior] The route definition behavior defining the created route
      #
      # @example
      ...
      # will be used.
      #
      # @param [Hash] defaults The default values for named segments.
      #
      # @param &block All routes defined in the block will be scoped to the
      #   defaults defined by the #default method.
      #
      # @yieldparam [Behavior] r The defaults behavior object (optional).
      #
      # @api public
      ...
      #
      # @param [Hash] options An options hash of options to set for all routes
      #   defined in the scope.
      # @option options :controller_prefix
      #   The module that the controller is included in.
      # @option options :name_prefix
      #   The prefix added to all routes named with #name
      #
      # @param &block
      #   All routes defined in the block will be scoped to the options defined
      #   by the #options method.
      #
      # @yieldparam [Behavior] r The options behavior object (optional).
      #
      # @example
      ...
      #
      # @param [Symbol, String] name_or_path
      #   The name or path of the namespace.
      #
      # @param [Hash] options Optional hash (see below)
      ...
      #
      # @yieldparam [Behavior] r The namespace behavior object (optional).
      #
      # @example
      #     namespace :admin do
      #       resources :accounts
      ...
      #   generation.
      # 
      # @yieldparam [Behavior] r The identify behavior object (optional).
      #
      # @api public
      ...
      #   possible.
      #
      # @return [Route] The default route
      #
      # @example
      ...
      #
      # @yield [request, params] The block takes two parameters, request and
      #   params. The params that are passed into the block are *just* the
      #   placeholder params from the route. If you want the full parsed
      #   params, use `request.params`.
      #
      # @note The rationale for the placeholer params passed to the block is
      #  that `request.params` is a fairly slow operation, and if the full
      #   params parsing is not required, we would rather not do the full
      #   parsing.
      #
      # @param [Hash] params Parameters and conditions associated with this
      #   behavior.
      ...
      #
      # @param [Symbol] symbol The name of the route.
      #
      # @raise [ArgumentError] `symbol` is not a Symbol.
      #
      # @api public
      ...
      #
      # @param [Boolean] enabled True enables fixation on the route.
      #
      # @api public
      ...
      # @option options [Boolean] :permanent (false)
      ...
      #
      # @param &block A context in which routes are generated.
      #
      # @api public
      def capture(&block)
        captured_routes = {}
      ...
      #
      # @param &block defines routes within the provided context.
      #
      # @api private
      ...
      #
      # @param [Route] route The route to insert before.
      # @param &block The route definition to insert.
      #
      # @api plugin
      ...
      # the block.
      #
      # @param [Behavior] behavior The behavior to proxy the calls in the block.
      # @param &block The routing definitions to be nested within the behavior.
      #
      # @return [Behavior] The behavior wrapping.
      #
      # @api private
      ...
      #
      # @param [String] path The path to merge at the end.
      #
      # @return [Array] Array of path elements.
      #
      # @note An array of `['a', 'b']` (the 'a' namespace with the 'b' action) will
